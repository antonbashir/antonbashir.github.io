  ...
  <div className={props.todo != true ? `project-card` : `card bg-base-200`}>
    <div className="card-body">
      ...
      <div className="card-actions">
        {props.documentation &&
          <a className="btn btn-primary btn-wide" href={props.documentation} target="_blank">
            ...
            Documentation</a>}
        {props.code && <a className="btn btn-primary btn-wide text-center inline-flex items-center" href={props.code} target="_blank">
