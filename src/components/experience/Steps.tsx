...
export const ExperienceSteps = () => {
  ...
  return <>
    ...
    <ExperienceStep delay={delay += (experiencePointDuration + experiencePathDuration)} duration={experienceStepDuration} sizing={{ left: 218, top: 1323, line: 100 }} left={false}>
      <div className="flex flex-row gap-1 place-items-center">
    ...
    <ExperienceStep delay={delay += (experiencePointDuration + experiencePathDuration)} duration={experienceStepDuration} sizing={{ left: 835, top: 1420, line: 50 }} left={true}>
      <div className="flex flex-row gap-1 place-items-center">
