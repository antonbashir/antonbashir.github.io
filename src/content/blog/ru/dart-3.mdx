...
2. Если доходим до функции создания дочерней корутины (`CoroutineFork`), останавливаемся 
3. Если доходим до функции иницализации основной корутины (`CoroutineInitialize`), до выполняем обработку изначального (нативного) стека
