...
3. Теперь нам нужно нашу библиотеку в реестр положить. Находим `runtime/vm/object.h`. Этот файл заслуживает отдельной... повести, потому что в нем 13595 строк. Но мы туда добавим строчку `static LibraryPtr FiberLibrary();` 
