...
### Компилятор потяжелее: constants_x64, stub_code_List, stub_code_compiler и stub_code_compiler_x64
...
### И напоследок: runtime_entry

Последняя интересная часть: наши RuntimeEntry. Выглядят они вот так:
...
Ах да, я же хотел после каждого цикла фиксировать уровень своей решимости. Здесь она 10%. Я был готов все бросить и сделал долгий перерыв. 
