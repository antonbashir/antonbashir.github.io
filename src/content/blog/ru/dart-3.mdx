...
Я думаю, можно придумать такую реализацию, чтобы это было возможно. Что-нибудь из контекста [stackless](https://habr.com/ru/articles/850970/) корутин и state-machine.
