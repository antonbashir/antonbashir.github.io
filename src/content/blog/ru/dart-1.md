...
Оказавшесь в определенном моменте разработки ART, я сформулировал ряд требований к реализации моих идей, и, к сожалению, Java под эти требования не попадала.
